...
2. Install TailwindCSS (follow Tailwind docs). Quick steps:
...
3. Replace src/App.jsx with the component below. Add assets to public or src/assets as noted.
4. Run the dev server: npm run dev
5. To deploy to Netlify: build (npm run build) and drop /dist or connect repo to Netlify.

Assets required (place in public/assets or src/assets):
- /assets/logo.svg  --> (SVG of the original-style logo; included below in the component as inline fallback)
- /assets/miss-director-1.jpg
- /assets/miss-director-2.jpg
- /assets/miss-director-3.jpg

Theme: Use logo colours except red as primary theme (we use teal/green/gold/soft-lavender accents).
*/
    ...
    <section id="home" className="py-16 grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
      <div>
        ...
        <div className="mt-8 flex gap-6 text-sm text-gray-600">
          ...
          <div><strong className="text-yellow-500">2</strong><div>Programs</div></div>
